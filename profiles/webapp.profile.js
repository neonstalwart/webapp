...
var profile = {
	...
	// move build-report.txt out of the distribution
	buildReportDir: '../',
	...
	layers: {
		'dojo/dojo': {
			include: [
				'dojo/i18n',
				'webapp/main',
				'webapp/widget/PageWidget'
				// since Dashboard is the default page, it could make sense to add it here too.
			],

			// By default, the build system will try to include `dojo/main` in the built `dojo/dojo` layer, which adds
			// a bunch of stuff we do not want or need. We want the initial script load to be as small and quick to
			// load as possible, so we configure it as a custom base.
			customBase: true
		},

		'webapp/page/Dashboard': {},

		'webapp/page/UserProfile': {}
	},
